...
MAX_CENTER_DISTANCE = 0.030 # maximum center distance for 2 centers to be considered equal
MAX_RADIUS_DISTANCE = 0.025 # maximum radius distance for 2 radiuses to be considered equal
