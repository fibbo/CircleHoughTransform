...
MAX_CENTER_DISTANCE = 0.015 # maximum center distance for 2 centers to be considered equal
MAX_RADIUS_DISTANCE = 0.010 # maximum radius distance for 2 radiuses to be considered equal
