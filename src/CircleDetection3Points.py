...
MAX_CENTER_DISTANCE = 0.1 # maximum center distance for 2 centers to be considered equal
MAX_RADIUS_DISTANCE = 0.05 # maximum radius distance for 2 radiuses to be considered equal
